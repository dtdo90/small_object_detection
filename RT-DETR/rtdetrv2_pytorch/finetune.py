...
def train_and_evaluate(
    ...
    warmup_steps, initial_lr=1e-06,  # learning rate warmup
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, batch in enumerate(progress_bar):
            ...
            if global_step<warmup_steps: # warmup
                ...
                # assign new lr manually during warmup
        ...
        # Close tqdm bar
        progress_bar.close()
        loss_epoch=loss_epoch / num_batches if num_batches > 0 else None
...
def main():
    ...
    lr_scheduler = torch.optim.lr_scheduler.MultiStepLR(
        optimizer,
        milestones=[4,6],  # decay LR at epochs 4,6,8
        gamma=0.1  # learning rate is multiplied by 0.1 at each milestone
    )
    ...
    model, num_epochs, train_loader, val_loader, optimizer, criterion, max_norm, device, 
    processor, threshold, lr_scheduler, warmup_steps)
